...
public class Adapter extends ArrayAdapter<app.android.inputdanlist.Gambar> {

    List<app.android.inputdanlist.Gambar> listgambar;
    Context context;
    int resource;

    public Adapter(Context context, int resource , List<app.android.inputdanlist.Gambar> listgambar) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        app.android.inputdanlist.Gambar gambar = listgambar.get(position);
